  ...
  return (
    <div className="flex items-center gap-1 p-1.5 rounded-[4px] border border-[#e6ebf8] bg-white shadow-[0_2px_4px_rgba(36,45,72,0.15)] w-fit max-w-full overflow-x-auto">
      ...
      <input
        ...
        className="bg-transparent border-none outline-none text-[0.875rem] leading-[1.2] font-semibold px-2 py-1 cursor-pointer hover:bg-[#f0f1f7] rounded-[4px] transition-colors flex-shrink-0"
      />
